...
public interface ProjectTester {
   ...
   */
  List<String> getOutgoingLinks(String url) throws IOException;
   ...
   */
  double getTF(String url, String word) throws IOException;

  /*
  Returns the TF-IDF value of the given word within the page with the given URL.
   */
  double getTFIDF(String url, String word) throws IOException;
   ...
   */
  List<SearchResult> search(String query, boolean boost, int X) throws IOException;
}
